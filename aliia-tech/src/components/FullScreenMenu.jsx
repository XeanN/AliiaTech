    ...
    const PhoneIcon = () => (
    <svg fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" className="w-6 h-6 mr-3 text-cyan-400"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-2.822-1.423-5.146-3.746-6.57-6.57l1.293-.97c.362-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 6.75z" /></svg>
    );
    const EmailIcon = () => (
    <svg fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" className="w-6 h-6 mr-3 text-cyan-400"><path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" /></svg>
    );
    const FacebookIcon = () => (
        ...
        <div className="fixed inset-0 z-[100] p-8 bg-dark-bg bg-opacity-95 backdrop-blur-sm text-white animate-menuFadeIn overflow-y-auto elegant-scroll">
            ...
            <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-y-4 md:gap-10">
                ...
                <div className="mt-12 pt-8 border-t border-gray-700">
                    ...
                    <a href="https://maps.google.com/?q=Av.+Circunvalación+del+Golf+los+Incas+208,+Oficina+1404+Torre+A" target="_blank" rel="noopener noreferrer" className={`flex items-center ${contactTextClass}`}>
                        <MapPinIcon />
                        Mi casita :D
                    </a>
                    <a href="tel:+5117162515" className={`flex items-center ${contactTextClass}`}>
                        <PhoneIcon />
                        (+51) 987654321
                    </a>
                    <a href="mailto:info@aliiatechcom" className={`flex items-center ${contactTextClass}`}>
                        <EmailIcon />
                        info@aliiatech.com
                    </a>
                    </div>
