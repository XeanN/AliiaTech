...
return (
    <section 
    className="h-[40vh] min-h-[300px] flex items-center justify-center relative text-white
                 [mask-image:linear-gradient(to_bottom,black_85%,transparent_100%)]" // <--- ¡CAMBIO HECHO AQUÍ!
    >
